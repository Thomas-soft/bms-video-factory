...
from factory.styles.whiteboard import WhiteboardEngine
...
STYLE_ENGINES: dict[str, type] = {
    ...
    "documentaire": DocumentaireEngine,  # 17    ffmpeg — banques libres + étalonnage
    "motion_design": MotionEngine,     # 30.1  revideo — scènes vectorielles, zéro image
    "whiteboard": WhiteboardEngine,    # 30.2  revideo — vtracer + tracé progressif
    "avatar2d": Avatar2dEngine,        # 29    ffmpeg — calques + Rhubarb, sur un style hôte
}
...
__all__ = [
    ...
    "get_engine", "moteur_de_chaine", "CartesEngine", "IllustreEngine", "DocumentaireEngine",
    "MotionEngine", "WhiteboardEngine", "Avatar2dEngine",
]

...
def executer(
    ...
    # Moteur avatar2d (étape 29) : temps propres à l'avatar, pour mesurer ce qu'il ajoute.
    for cle, valeur in mesures.items():
        if cle.startswith("avatar_") and isinstance(valeur, (int, float)):
            manifest.execution.timings[f"render_{cle}"] = float(valeur)
